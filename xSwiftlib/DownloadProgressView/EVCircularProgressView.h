...
typedef enum : NSUInteger {
    ProgressLayerTypeSquare,
    ProgressLayerTypePause
} ProgressLayerType;
...
@property (nonatomic, strong) Color *progressBgTintColor;
@property (nonatomic, assign) ProgressLayerType progressType;
